...
const covid19ImpactEstimator = (data) => {
  ...
  severeImpact.dollarsInFlight = Math.trunc((severeImpact.infectionsByRequestedTime * data.region.avgDailyIncomePopulation * data.region.avgDailyIncomeInUSD) / convertToDays(data));
